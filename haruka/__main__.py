...
def send_start(bot, update):
    ...
    text = "Hey there! My name is Lucifer Morningstar! So tell what is that you desire then most? - I'm here to help you manage your groups!\n\
Click Help button to find out more about how to use me to my full potential.\n\n"

    text += "Follow ( @luciferbotsupport) if you want to keep up with the news, updates and bot downtime!\n\n\
Mainatined by @ChevroletImpala67\n\nWant to add me to your group? [Click here!](t.me/lucifermorniingstar_bot?startgroup=true)"

    keyboard = [[InlineKeyboardButton(text="Updates", url="https://t.me/luciferbotsupport")]]
